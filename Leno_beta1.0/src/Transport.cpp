...
double Transport::interTunnel2DOFP(double Ect, double Evt, double Ecb, double Evb, double Vds, double precision)
{
...
double Transport::likeTunnel2DOFP(double Ect, double Evt, double Ecb, double Evb, double Vds, double precision)
{
    double mvt = 0.4*m0, mcb = 0.3*m0;
    double mct = 0.3*m0, mvb = 0.4*m0;
...
std::vector<double> Transport::getInterTunnelCurrent() {
		return (interTunnelCurrent);
}


std::vector<double> Transport::getLikeTunnelCurrent() {
