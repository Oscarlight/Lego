...
0. What is Changed (from v1.0)
	...
	b. threshold at the edge of transistor, undercut effect
	c. Add fix Chrage in insulator 
	d. More output method.
	e. Add subgap DOS to 1D Poisson. 
	

"For now, non-uniform meshing only support 2 - 3 times difference."
